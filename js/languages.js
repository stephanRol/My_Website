...
let languages = {
  EN: {
    ...
    about: {
      title: "About me",
      text: "My name is Stephan and I am an electrical engineer graduated from the Universidad de la Frontera, in Temuco, Chile, with a brief work experience in Santiago de Chile. I am currently living in Germany and in the past I worked in the area of automation of industries, specifically automation in intralogistics based on the development of industry 4.0, in the position of PLC programmer.<br><br>In the year 2020 I decided to change the area and enter the wonderful world of computer programming, so I started a training of 'Fullstack developer' for a duration of 6 months, in the training center Alfatraining in Hamburg, Germany. At the end of the training I decided to go deeper into frontend development, learning various technologies. Currently I am proficient in HTML5, CSS, JavaScript, React, TypeScript, Sass, Bootstrap, Node.js and Git.<br><br>My university degree has been validated and recognized by the Baden-Wurtemberg Chamber of Engineers in Germany and I have a certified C1 level in German from the Goethe Institut. Furthermore I have intermediate knowledge of English.",
    },
    skills: {
      title: "Skills",
    },
